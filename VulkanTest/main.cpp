...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("F:/VSObjects/VulkanTest/VulkanTest/VulkanTest/vert.spv");
        auto fragShaderCode = readFile("F:/VSObjects/VulkanTest/VulkanTest/VulkanTest/frag.spv");
